...
<Library LVVersion="19008000">
	...
	<Item Name="Public" Type="Folder">
		...
		<Item Name="Motion" Type="Folder">
			...
			<Item Name="Send_Trajectory.vi" Type="VI" URL="../Public/Motion/Send_Trajectory.vi"/>
		</Item>
		<Item Name="Status" Type="Folder">
			<Item Name="Angular" Type="Folder">
				<Item Name="Get_Angular_Command.vi" Type="VI" URL="../Public/Status/Angular/Get_Angular_Command.vi"/>
				<Item Name="Get_Angular_Position.vi" Type="VI" URL="../Public/Status/Angular/Get_Angular_Position.vi"/>
			</Item>
			<Item Name="Cartesian" Type="Folder">
	...
	<Item Name="Kinova MICO² USB Readme.html" Type="Document" URL="../Kinova MICO² USB Readme.html"/>
</Library>
